...
d_txAD_2702 ~v0 ~v1 v2 = du_txAD_2702 v2
du_txAD_2702 :: T_GeneralizeTel_32575 -> Maybe AgdaAny
du_txAD_2702 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txAD_3412
      (coe d_'46'generalizedField'45'tx_32567 (coe v0))
...
d_wits_2708 ::
  ...
  T_GeneralizeTel_32575 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxWitnesses_3370
d_wits_2708 ~v0 ~v1 v2 = du_wits_2708 v2
du_wits_2708 ::
  T_GeneralizeTel_32575 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxWitnesses_3370
du_wits_2708 v0
...
d_txADhash_2724 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2250 ->
  T_GeneralizeTel_32575 -> Maybe AgdaAny
d_txADhash_2724 ~v0 ~v1 v2 = du_txADhash_2724 v2
du_txADhash_2724 :: T_GeneralizeTel_32575 -> Maybe AgdaAny
du_txADhash_2724 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txADhash_3268
      (coe
...
du_txId_2736 :: T_GeneralizeTel_32575 -> AgdaAny
du_txId_2736 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txId_3258
      (coe
...
d_scripts_2750 ~v0 ~v1 v2 = du_scripts_2750 v2
du_scripts_2750 ::
  T_GeneralizeTel_32575 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
du_scripts_2750 v0
  = coe
...
d_txdats_2754 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2250 ->
  T_GeneralizeTel_32575 -> [AgdaAny]
d_txdats_2754 ~v0 ~v1 v2 = du_txdats_2754 v2
du_txdats_2754 :: T_GeneralizeTel_32575 -> [AgdaAny]
du_txdats_2754 v0
  = coe
...
d_vkSigs_2758 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2250 ->
  T_GeneralizeTel_32575 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_vkSigs_2758 ~v0 ~v1 v2 = du_vkSigs_2758 v2
du_vkSigs_2758 ::
  T_GeneralizeTel_32575 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_vkSigs_2758 v0
  = coe
                              ...
                              (coe
                                 (\ v3 ->
                                    coe
                                      ...
                                      (coe v3)
                                      (coe
                                         du_allowedLanguages_2632 (coe v0) (coe v1)
                                         (coe
                                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_utxo_2362
                                            (coe v2)))))
                              (coe
                                 du_languages_2618 (coe v0) (coe v1)
                                 (coe
                                    MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_utxo_2362
                                    (coe v2))))
                           (coe
...
d_'46'generalizedField'45'tx_32567 ::
  T_GeneralizeTel_32575 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3392
d_'46'generalizedField'45'tx_32567 v0
  = case coe v0 of
...
data T_GeneralizeTel_32575
  = C_mkGeneralizeTel_32577 MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3392
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2352
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2336
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2352
