...
data T_EpochState_2730
  = C_'10214'_'44'_'44'_'44'_'44'_'10215''7497'''_2752 MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_164
                                                       MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshots_2904
                                                       MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2500
                                                       MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1054
                                                       MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2556
      ...
      C_'10214'_'44'_'44'_'44'_'44'_'10215''7497'''_2752 v3 v4 v5 v6 v7
        -> case coe v3 of
             MAlonzo.Code.Ledger.Conway.Specification.PParams.C_'10214'_'44'_'10215''7491'_174 v8 v9
               -> case coe v5 of
                    MAlonzo.Code.Ledger.Conway.Conformance.Ledger.C_'10214'_'44'_'44'_'10215''737'_2514 v10 v11 v12
                      -> case coe v10 of
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (coe
                                                                              ...
                                                                              (coe
                                                                                 MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                                                  (coe
                                                                     MAlonzo.Code.Ledger.Conway.Conformance.Ledger.C_'10214'_'44'_'44'_'10215''737'_2514)))
                                                            (coe
                                                               MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                               (coe
                                                                  MAlonzo.Code.Ledger.Prelude.du_'10214'_'10215'_72
...
data T__'8866'_'8640''10631'_'44'EPOCH'10632'__2876
  = C_EPOCH_2998 MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80
                 MAlonzo.Code.Ledger.Conway.Conformance.Rewards.T__'8866'_'8640''10631'_'44'SNAP'10632'__2500
-- Ledger.Conway.Conformance.Epoch._.certState
d_certState_2880 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2250 ->
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1498
...
du_certState_2880 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2512
      (coe d_'46'generalizedField'45'ls_41041 (coe v0))
-- Ledger.Conway.Conformance.Epoch._.govSt
d_govSt_2882 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2250 ->
  T_GeneralizeTel_41057 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_es_2898 v0
  = coe
      ...
      (coe d_'46'generalizedField'45'fut_41043 (coe v0))
...
d_'46'generalizedField'45'ls_41041 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2500
d_'46'generalizedField'45'ls_41041 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-fut
d_'46'generalizedField'45'fut_41043 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2556
d_'46'generalizedField'45'fut_41043 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-e
d_'46'generalizedField'45'e_41045 ::
  T_GeneralizeTel_41057 -> AgdaAny
d_'46'generalizedField'45'e_41045 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-acnt
d_'46'generalizedField'45'acnt_41047 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_164
d_'46'generalizedField'45'acnt_41047 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-ss'
d_'46'generalizedField'45'ss''_41049 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshots_2904
d_'46'generalizedField'45'ss''_41049 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-fut'
d_'46'generalizedField'45'fut''_41051 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2556
d_'46'generalizedField'45'fut''_41051 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-ss
d_'46'generalizedField'45'ss_41053 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshots_2904
d_'46'generalizedField'45'ss_41053 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-es₀
d_'46'generalizedField'45'es'8320'_41055 ::
  T_GeneralizeTel_41057 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1054
d_'46'generalizedField'45'es'8320'_41055 v0
  = case coe v0 of
      C_mkGeneralizeTel_41059 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch.GeneralizeTel
d_GeneralizeTel_41057 a0 a1 = ()
data T_GeneralizeTel_41057
  = C_mkGeneralizeTel_41059 MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2500
                            MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2556
