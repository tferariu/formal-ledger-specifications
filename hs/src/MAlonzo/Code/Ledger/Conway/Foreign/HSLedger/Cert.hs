...
d_Computational'45'CERTS_14
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Certs.Properties.d_Computational'45'CERTS_2486
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_govStructure_2494
         (coe
            MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.ExternalStructures.d_HSTransactionStructure_774
...
d_HsTy'45'CertState_476 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'CertState_476 = erased
-- Ledger.Conway.Foreign.HSLedger.Cert.Conv-CertState
d_Conv'45'CertState_478 ::
...
d_Conv'45'CertState'45'CertState''_480 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'CertState'45'CertState''_480
  = coe
      MAlonzo.Code.Foreign.Convertible.C_constructor_22
...
certsStep ::
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_ComputationResult_44
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_CertState_713
certsStep = coe d_certs'45'step_494
d_certs'45'step_494 ::
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_CertEnv_7769 ->
  T_CertState_713 ->
  [MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_DCert_16469] ->
...
certStep ::
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_ComputationResult_44
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_CertState_713
certStep = coe d_cert'45'step_496
d_cert'45'step_496 ::
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_CertEnv_7769 ->
  T_CertState_713 ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_DCert_16469 ->
...
d_CertState_713 = ()
type T_CertState_713 = CertState
pattern C_MkCertState_715 a0 a1 a2 = MkCertState a0 a1 a2
check_MkCertState_715 ::
  ...
  T_CertState_713
check_MkCertState_715 = MkCertState
cover_CertState_713 :: CertState -> ()
cover_CertState_713 x
  = case x of
      MkCertState _ _ _ -> ()
