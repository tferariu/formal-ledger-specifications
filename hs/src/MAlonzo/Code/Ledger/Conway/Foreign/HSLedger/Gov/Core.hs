...
d_Conv'45'VDeleg_34
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_vDelegCredential_806 v1
                -> coe
...
d_Conv'45'GovVotes_42
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_constructor_970 v1 v2 v3
                -> coe
                     C_GovVotes_1263
                     (coe
